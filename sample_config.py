...
# تم إضافة هذا المتغير لمنع كراش الملحقات
heroku_var = False
...
class Config(object):
    ...
    # تم التعديل ليقرأ من DATABASE_URL الخاص بـ Fly.io أولاً
    ...
    # تم تغيير False إلى None لمنع كراش هيروكو
    ...
    # تم التعديل لتفادي خطأ Boolean object has no attribute 'lower'
